...
//		Long l =session.getAttribute("userInfo").getUserNo();
	//3.어따담기
//		Map<String , String > map = new HashMap();
//		map.put("userName",userName);
//		map.put("email",email);
//		
//		Map.of() : 키와 벨류가 10개까지 초기화 가능 불변맵 반환
	...
	//5. 결과값에 따라서 응답화면 지정
		if(result>0) {
			//생긴 문제점 , Update에 성공했는데 session의 userInfo키 값에는 로그인 당시/마이페이지 포워딩 당시 조회했던
			//값들이 필드에 담겨있기 떄문에 Update수행 전 값들이 마이페이지에서 출력됨
